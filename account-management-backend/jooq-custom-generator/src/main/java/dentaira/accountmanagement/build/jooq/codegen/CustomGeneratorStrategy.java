...
public class CustomGeneratorStrategy extends DefaultGeneratorStrategy {
   ...
   *
   * <p>Table や Record は Repository から参照するためにモジュールとして設定したいが、 デフォルトのパッケージ構成だと循環参照になっていて Spring
   * Modulith に適さないためカスタマイズする。 全ファイル一律同じパッケージに作成することで１つのモジュールにまとめることで、モジュール間の循環参照を解消する。
   */
  @Override
